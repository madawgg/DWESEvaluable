...
Class Fermentacion extends Invento{
    ...
    public function __toString(): string {
        ...
        $html .= $this->material;
        $html .= '<tr><th>Resistencia Química</th><td>' . htmlspecialchars($this->material->resistenciaQuimica) . ' minutos</td></tr>';
        $html .= '<tr><th>Resistencia a la Humedad</th><td>' . htmlspecialchars($this->material->resistenciaHumedad) . ' minutos</td></tr>';
