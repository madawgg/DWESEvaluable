...
class Ganaderia extends Almacenamiento implements Medible{
    ...
    protected static array $campos = [
        ['nombre' => 'cuerdas', 'tipo' => 'select', 'variable' => 'Cuerda'],
        ['nombre' => 'piedrasAfiladas', 'tipo' => 'select', 'variable' => 'PiedraAfilada'],
        ['nombre' => 'trampas', 'tipo' => 'select', 'variable' => 'Trampa'],
        ['nombre' => 'refugios', 'tipo' => 'select', 'variable' => 'Refugio'],
