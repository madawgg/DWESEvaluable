...
class ArcoFlecha extends Invento implements Medible{
    ...
    public function __construct(string $nombre, Material $materialArco, Lanza $flecha, Cuerda $cuerda, string $tecnica, array $tamanyo, string $zonaCreacion = null, string $metodoCreacion = null){
