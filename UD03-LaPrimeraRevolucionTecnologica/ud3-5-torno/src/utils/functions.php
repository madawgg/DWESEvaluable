...
function principal()
{
	...
	$materialTierra = $materiales['caolinita'];
	$ceramica       = new Ceramica('CeramicaPrueba', $materialTierra, $fuego, $cesta);
	Alfareria::probarInvento(['AlfareríaPrueba', $materialTierra, $fuego, $ceramica, $refugio]);

	echo '<h2>Torno</h2>';
	$alfareria = new Alfareria('AlfareríaPrueba', $materialTierra, $fuego, $ceramica, $refugio);
	Torno::probarInvento(['TornoPrueba', 10, 10, $alfareria, $ceramica, $rueda, null,'rapido']);
}
